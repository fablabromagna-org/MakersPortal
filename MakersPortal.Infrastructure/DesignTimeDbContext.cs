...
namespace MakersPortal.Infrastructure
{
    ...
    public class DesignTimeDbContext : DesignTimeDbContext<MakersPortalDbContext>
    {
        protected override MakersPortalDbContext CreateNewInstance(DbContextOptions<MakersPortalDbContext> options)
        {
            return new MakersPortalDbContext(options);
        }
    }
}